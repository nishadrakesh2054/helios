...
const contactInfo = [
  { title: 'Phone', subTitle: '01- 5912170, 5912270, 5912370, 5421316' },
  { title: 'Email Us', subTitle: 'info@heliosnepal.com, appointment@heliosnepal.com' },
  { title: 'Our Location', subTitle: 'Shaligram Village complex, Opposite staff College, Jawalakhel-4, Lalitpur' },
    { title: 'Opening Hours', subTitle: 'Sunday to Friday: 7:30 am – 6:00 pm' },
