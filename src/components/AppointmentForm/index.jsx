  ...
  return (
    <form action="#" className="row g-4">
      ...
      <div className="col-lg-6">
        ...
        <div className="cs_select_wrapper">
          <select className="cs_form_field cs_select_field">
            <option value="">Select Gender</option>
            <option value="male">Male</option>
            <option value="female">Female</option>
            <option value="other">Other</option>
          </select>
          <Icon icon="fa6-solid:chevron-down" className="cs_select_arrow" />
        </div>
      </div>
      ...
      <div className="col-lg-6">
        ...
        <div className="cs_select_wrapper">
          <select className="cs_form_field cs_select_field">
            ...
            <option value="dr_sanjay_gurung">
              Dr. Sanjay Gurung (Cardiologist)
            </option>
            <option value="dr_anita_shrestha">
              Dr. Anita Shrestha (Gynecologist)
            </option>
            <option value="dr_prakash_adhikari">
              Dr. Prakash Adhikari (General Physician)
            </option>
            <option value="dr_reshma_karki">
              Dr. Reshma Karki (Pediatrician)
            </option>
            <option value="dr_krishna_rai">
              Dr. Krishna Rai (Orthopedic Specialist)
            </option>
            <option value="dr_sabina_tamang">
              Dr. Sabina Tamang (Dermatologist)
            </option>
          </select>
          <Icon icon="fa6-solid:chevron-down" className="cs_select_arrow" />
        </div>
